...
src/app/bhr-client.whl:
	curl -o bhr-client.whl https://files.pythonhosted.org/packages/4a/23/1bbb1bee8f4ee5daf8feffea6bd3a8d58e53f2a7633c6d228836f44bb3c5/bhr_client-1.6-py3-none-any.whl
	mv bhr-client.whl ./src/app
	pwd
	ls

$(PACKAGE).tar: src/app/bhr-client.whl version $(SOAR_SRCS)
